...
function AssistantContent({ onAddItem, onAddItems, onSetLabourContext }: AssistantSidebarProps) {
  return (
    <Tabs defaultValue="problems" className="flex-1 flex flex-col">
      <TabsList className="w-full grid grid-cols-2 h-10 mb-3 mx-0">
        <TabsTrigger value="problems" className="gap-1.5 text-xs font-semibold">
          <Wrench className="h-3.5 w-3.5" />
          Problème & Gestes
        </TabsTrigger>
        <TabsTrigger value="material" className="gap-1.5 text-xs font-semibold">
